...
importers:
  ...
  packages/component-kit:
    specifiers:
      '@babel/core': ^7.19.3
      '@strangelovelabs/style-guide': ^0.0.3
      '@types/react': ^18.0.17
    ...
    devDependencies:
      '@babel/core': 7.19.3
      '@strangelovelabs/style-guide': 0.0.3_gdw6c6hvx3ofvutksankatp6m4
      '@types/react': 18.0.21
      '@types/react-dom': 18.0.6
      ...
      typescript: 4.8.4
      vite: 3.1.8
      vite-plugin-dts: 1.6.6_vite@3.1.8
...
packages:
  ...
  /@microsoft/api-extractor-model/7.25.1:
    resolution: {integrity: sha512-AaZ0ohCGLRjWiZviM+0p/DaxgMhbawS183LW2+CSqyEBh6wZks7NjoyhzhibAYapS4omnrmv96+0V/2wBvnIZQ==}
    dependencies:
  ...
  /@microsoft/api-extractor/7.33.2:
    resolution: {integrity: sha512-OTCOtpQgvvRnxyCAHCPEDXVyJXrj54sGNCltOQaaT1wkTUPmRYo/I8yrCGXiBPUIHOpV3lUnaDJkzQF9dtbNWA==}
    hasBin: true
    dependencies:
      '@microsoft/api-extractor-model': 7.25.1
      '@microsoft/tsdoc': 0.14.1
  ...
  /@strangelovelabs/style-guide/0.0.3_gdw6c6hvx3ofvutksankatp6m4:
    resolution: {integrity: sha512-twOUl+WOnzZONnIOQposhm9Y+sxV2qpdftJyIljVwtING2tA2BS6gLESg+zMoUYPSp0p0MH1lX6oXMvcBmzGMw==}
    peerDependencies:
      eslint: ^8
      prettier: ^2
      typescript: ^4
    dependencies:
      ...
      eslint-plugin-prefer-arrow-functions: 3.1.4_eslint@8.25.0
      ...
      eslint-plugin-simple-import-sort: 7.0.0_eslint@8.25.0
      eslint-plugin-tsdoc: 0.2.17
      eslint-plugin-unicorn: 43.0.2_eslint@8.25.0
      eslint-plugin-unused-imports: 2.0.0_f7lcnv6avoszhva7xxk5tg6wiq
      prettier: 2.7.1
      typescript: 4.8.4
    optionalDependencies:
      '@next/eslint-plugin-next': 12.3.1
      eslint-plugin-jest: 26.9.0_fnfglsc5nqp5xzalbznsqhga7q
      eslint-plugin-tailwindcss: 3.6.2
      eslint-plugin-testing-library: 5.7.2_z4bbprzjrhnsfa24uvmcbu7f5q
    transitivePeerDependencies:
      - '@babel/core'
  ...
  /eslint-module-utils/2.7.4_7tcdo3mvaea4tfmgdfmifqozny:
  ...
  /eslint-plugin-prefer-arrow-functions/3.1.4_eslint@8.25.0:
    resolution: {integrity: sha512-LSO8VibqBKqzelr+L21mEIfachavCon+1SEumCJ6U8Ze2q0pntyojmomcVwd9RZBjrP+HV6k1Osz0B3Xwdq8WA==}
    peerDependencies:
      eslint: '>=5.0.0'
    dependencies:
      eslint: 8.25.0
  ...
  /eslint-plugin-tailwindcss/3.6.2:
    resolution: {integrity: sha512-C9Ka3w6W9F5l/3ZDLnkdbqmeujc1vE+p5drjP1Z1UyxgoE1Nh4/f8oQ4XC45PrZsS0Nyv0YKXNH8/dn/FJZKsQ==}
